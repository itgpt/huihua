...
export function showAnnouncement() {
        ...
        <div class="toast-content">
            ...
            <div class="toast-section">
                ...
                <div class="link-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 8px;">
                    <a href="https://qj.wanwuhuanxin.cn" target="_blank" class="link-card">
                        <span>🚀</span> 主站
                    </a>
                    <a href="https://qj.wanwuhuanxin.cn" target="_blank" class="link-card">
                        <span>🔢</span> 次数站
            ...
            <div class="toast-section">
                ...
                <p style="margin-top: 5px;">
                    <span class="wechat-id" title="点击复制" id="wechatId">wang15773939363</span>
    ...
    if (wechatIdSpan) {
        wechatIdSpan.onclick = () => {
            navigator.clipboard.writeText('wang15773939363').then(() => {
                showSuccess('已复制到剪贴板: wang15773939363');
